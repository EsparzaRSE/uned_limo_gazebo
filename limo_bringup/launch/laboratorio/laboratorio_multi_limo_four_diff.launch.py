...
def generate_launch_description():
    ...
    xacro_path = os.path.join(get_package_share_path('uned_limo_gazebo'), 'limo_description', 'urdf', 'stl', 'limo_four_diff.xacro')
    world_path = os.path.join(pkg_dir, 'limo_bringup', 'worlds', 'laboratorio.sdf')
    rviz_config_path = os.path.join(pkg_dir, 'limo_description', 'rviz', 'multi_model_display_four_diff.rviz')
    bridge_params = [
    ...
    robot_names = ['limo0_four_diff/', 'limo1_four_diff/', 'limo2_four_diff/', 'limo3_four_diff/', 'limo4_four_diff/']
    ...
    for robot_name in robot_names:
        ...
        # Crea un archivo temporal con el nombre del robot en el nombre del archivo
